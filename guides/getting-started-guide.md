...
1. Repositories and Licenses - List initial repositor(ies) you would like to set up with the preferred licenses for each, chosen from the list of approved licenses.
